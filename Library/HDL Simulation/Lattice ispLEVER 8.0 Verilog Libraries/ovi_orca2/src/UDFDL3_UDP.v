...
//
// $Header: /home/dmsys/pvcs/RCSMigTest/rcs/verilog/pkg/versclibs/data/orca2/RCS/UDFDL3_UDP.v,v 1.3 2005/05/19 18:06:33 pradeep Exp $ 
//
...
primitive UDFDL3_UDP ( Q, PRE, PD, PE);
input PRE, PD, PE;
output Q ;
reg Q ;
initial Q=1'b1;
