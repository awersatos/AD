...
//
// $Header: /home/dmsys/pvcs/RCSMigTest/rcs/verilog/pkg/versclibs/data/orca2a/RCS/SYN6RAM.v,v 1.3 2005/05/19 18:26:23 pradeep Exp $ 
//
...
// 1.2    Jun 98   swt    16X1 Read Only Memory 
//*********************************************
/* 
   Verilog model for ORCA's 16 word by 1 bit Read Only Memory.
...
`ifdef DEBUG
initial begin
  $display ("in SYN6RAM.v, init_value: %h", init_value);
   for (i=0; i < 16; i=i+1) begin
