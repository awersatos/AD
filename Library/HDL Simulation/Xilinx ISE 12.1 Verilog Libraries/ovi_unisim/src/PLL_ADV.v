// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/rainier/PLL_ADV.v,v 1.70 2010/02/11 00:23:21 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
...
reg [2:0] clkfbm1pm_sel, clkfbm2pm_sel;
...
initial begin
        ...
        chk_ok = para_int_pmcd_chk(CLKOUT0_DIVIDE, tmp_string, 1, 128, pmcd_mode, 8);
         if (clkfb_src == 1)  begin
            if (CLKOUT0_PHASE > 0.001 || CLKOUT0_PHASE < - 0.001)
               $display("Attribute Syntax Error : The Attribute CLKOUT0_PHASE on PLL_ADV instance %m is set to %f.  This attribute should be set to 0.0 when attribute CLKFB_FEEDBACK set to CLKOUT0.", CLKOUT0_PHASE);
         end
         else begin
...
//       val_tmp = period_vco * md_product;
  ...
  always @(clkfbm1_ht or clkfbm1_lt or clkfbm1_nocnt or init_trig or clkfbm1_edge)
   ...
   always @( clkfbm1_dly or  init_trig)
      if (clkfb_src ==1)
            clkfbm_dly = 0;
      else
