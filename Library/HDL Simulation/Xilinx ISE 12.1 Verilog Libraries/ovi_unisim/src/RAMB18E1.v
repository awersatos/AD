// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/blanc/RAMB18E1.v,v 1.16.36.1 2010/03/29 22:53:05 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module RAMB18E1 (DOADO, DOBDO, DOPADOP, DOPBDOP,
	...
	if (RAM_MODE == "SDP") begin
		...
		$display("DRC Error : The attribute WRITE_MODE_A on RAMB18E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_A);
		finish_error = 1;
	    end
	    
		
	    if (WRITE_MODE_B != "READ_FIRST") begin
		$display("DRC Error : The attribute WRITE_MODE_B on RAMB18E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_B);
		finish_error = 1;
	    end
