// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/blanc/RAMB36E1.v,v 1.17.36.1 2010/03/29 22:53:05 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module RAMB36E1 (CASCADEOUTA, CASCADEOUTB, DBITERR, DOADO, DOBDO, DOPADOP, DOPBDOP, ECCPARITY, RDADDRECC, SBITERR, 
	...
	if (RAM_MODE == "SDP") begin
		...
		$display("DRC Error : The attribute WRITE_MODE_A on RAMB36E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_A);
		finish_error = 1;
	    end
	    
		
	    if (WRITE_MODE_B != "READ_FIRST") begin
		$display("DRC Error : The attribute WRITE_MODE_B on RAMB36E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_B);
		finish_error = 1;
	    end
