// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/rainier/X_ARAMB36_INTERNAL.v,v 1.34 2009/12/17 19:36:26 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
// /___/   /\     Filename : X_ARAMB36_INTERNAL.v
...
module X_ARAMB36_INTERNAL (CASCADEOUTLATA, CASCADEOUTLATB, CASCADEOUTREGA, CASCADEOUTREGB, DBITERR, DOA, DOB, DOPA, DOPB, ECCPARITY, SBITERR, 
...
/******************************************** END task and function **************************************/
	...
	case (WRITE_WIDTH_A)
	    ...
	    36 : begin 
			 ...
			 $display("Attribute Syntax Error : The attribute WRITE_WIDTH_A on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.", WRITE_WIDTH_A);
			 $finish;
		     end
		 end
	    72 : begin
			 ...
			 $display("Attribute Syntax Error : The attribute WRITE_WIDTH_A on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.", WRITE_WIDTH_A);
			 $finish;
		     end
	         end
	    default : begin
	...
	endcase // case(WRITE_WIDTH_A)
	    ...
	    36 : begin 
		     if (BRAM_SIZE == 18 && BRAM_MODE == "TRUE_DUAL_PORT") begin
			 $display("Attribute Syntax Error : The attribute WRITE_WIDTH_B on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.", WRITE_WIDTH_B);
			 $finish;
		     end
		 end
	    72 : begin
			 ...
			 $display("Attribute Syntax Error : The attribute WRITE_WIDTH_B on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.", WRITE_WIDTH_B);
			 $finish;
		     end
	         end
	    default : begin
	...
	case (READ_WIDTH_A)
	    ...
	    36 : begin 
		     if (BRAM_SIZE == 18 && BRAM_MODE == "TRUE_DUAL_PORT") begin
			 $display("Attribute Syntax Error : The attribute READ_WIDTH_A on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.", READ_WIDTH_A);
			 $finish;
		     end
		 end
	    72 : begin
			 ...
			 $display("Attribute Syntax Error : The attribute READ_WIDTH_A on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.", READ_WIDTH_A);
			 $finish;
		     end
	         end
	    default : begin
	...
	endcase // case(READ_WIDTH_A)
	    ...
	    36 : begin 
		     if (BRAM_SIZE == 18 && BRAM_MODE == "TRUE_DUAL_PORT") begin
			 $display("Attribute Syntax Error : The attribute READ_WIDTH_B on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.", READ_WIDTH_B);
			 $finish;
		     end
		 end
	    72 : begin
			 ...
			 $display("Attribute Syntax Error : The attribute READ_WIDTH_B on X_ARAMB36_INTERNAL instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.", READ_WIDTH_B);
			 $finish;
		     end
	         end
	    default : begin
	...
	if ((RAM_EXTENSION_A == "LOWER" || RAM_EXTENSION_A == "UPPER") && READ_WIDTH_A != 1) begin
	    $display("Attribute Syntax Error : If attribute RAM_EXTENSION_A on X_ARAMB36_INTERNAL instance %m is set to either LOWER or UPPER, then READ_WIDTH_A has to be set to 1.");
	    $finish;
	end

	
	if ((RAM_EXTENSION_A == "LOWER" || RAM_EXTENSION_A == "UPPER") && WRITE_WIDTH_A != 1) begin
	    $display("Attribute Syntax Error : If attribute RAM_EXTENSION_A on X_ARAMB36_INTERNAL instance %m is set to either LOWER or UPPER, then WRITE_WIDTH_A has to be set to 1.");
	    $finish;
	end


	 if ((RAM_EXTENSION_B == "LOWER" || RAM_EXTENSION_B == "UPPER") && READ_WIDTH_B != 1) begin
	    $display("Attribute Syntax Error : If attribute RAM_EXTENSION_B on X_ARAMB36_INTERNAL instance %m is set to either LOWER or UPPER, then READ_WIDTH_B has to be set to 1.");
	    $finish;
	end


	if ((RAM_EXTENSION_B == "LOWER" || RAM_EXTENSION_B == "UPPER") && WRITE_WIDTH_B != 1) begin
	    $display("Attribute Syntax Error : If attribute RAM_EXTENSION_B on X_ARAMB36_INTERNAL instance %m is set to either LOWER or UPPER, then WRITE_WIDTH_B has to be set to 1.");
	    $finish;
	end


	if (READ_WIDTH_A == 0 && READ_WIDTH_B == 0) begin
	    $display("Attribute Syntax Error : Attributes READ_WIDTH_A and READ_WIDTH_B on X_ARAMB36_INTERNAL instance %m, both can not be 0.");
	    $finish;
	end
	...
	case (WRITE_MODE_A)
	    ...
	    default       : begin
				$display("Attribute Syntax Error : The Attribute WRITE_MODE_A on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.", WRITE_MODE_A);
				$finish;
			    end
	endcase
	...
	case (WRITE_MODE_B)
	    ...
	    default       : begin
				$display("Attribute Syntax Error : The Attribute WRITE_MODE_B on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.", WRITE_MODE_B);
				$finish;
			    end
	endcase
	...
	case (RAM_EXTENSION_A)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute RAM_EXTENSION_A on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.", RAM_EXTENSION_A);
		          $finish;
		      end
	endcase
	...
	case (RAM_EXTENSION_B)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute RAM_EXTENSION_B on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.", RAM_EXTENSION_B);
		          $finish;
		      end
	endcase
	...
	if (!(EN_ECC_WRITE == "TRUE" || EN_ECC_WRITE == "FALSE")) begin
	    $display("Attribute Syntax Error : The attribute EN_ECC_WRITE on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", EN_ECC_WRITE);
	    $finish;
	end

	
	if (!(EN_ECC_READ == "TRUE" || EN_ECC_READ == "FALSE")) begin
	    $display("Attribute Syntax Error : The attribute EN_ECC_READ on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", EN_ECC_READ);
	    $finish;
	end

	if (EN_ECC_SCRUB == "TRUE") begin
	    $display("DRC Error : The attribute EN_ECC_SCRUB = TRUE is not supported on X_ARAMB36_INTERNAL instance %m.");
	    $finish;
	end
	
	if (!(EN_ECC_SCRUB == "TRUE" || EN_ECC_SCRUB == "FALSE")) begin
	    $display("Attribute Syntax Error : The attribute EN_ECC_SCRUB on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", EN_ECC_SCRUB);
	    $finish;
	end

	
	if (EN_ECC_READ == "FALSE" && EN_ECC_SCRUB == "TRUE") begin
	    $display("DRC Error : The attribute EN_ECC_SCRUB = TRUE is vaild only if the attribute EN_ECC_READ set to TRUE on X_ARAMB36_INTERNAL instance %m.");
	    $finish;
	end
	...
	if ((SIM_COLLISION_CHECK != "ALL") && (SIM_COLLISION_CHECK != "NONE") && (SIM_COLLISION_CHECK != "WARNING_ONLY") && (SIM_COLLISION_CHECK != "GENERATE_X_ONLY")) begin
	    ...
	    $display("Attribute Syntax Error : The attribute SIM_COLLISION_CHECK on X_ARAMB36_INTERNAL instance %m is set to %s.  Legal values for this attribute are ALL, NONE, WARNING_ONLY or GENERATE_X_ONLY.", SIM_COLLISION_CHECK);
	    $finish;
...
/**************************** Port A ****************************************/
	if (rising_clka) begin
		...
		$display("DRC Warning : SET/RESET (SSR) is not supported in ECC mode on X_ARAMB36_INTERNAL instance %m.");
	    
	    if (ssra_in === 1 && BRAM_SIZE == 16 && DOA_REG == 1) begin
		$display("DRC Error : SET/RESET (SSR) is not supported when optional output registers are used on X_ARAMB36_INTERNAL instance %m.");
		$finish;
	    end
...
/************************************** port B ***************************************************************/	
	...
	if (enb_in && (rising_clkb || viol_time != 0)) begin
		...
		if (wr_mode_b == 2'b00 && BRAM_SIZE == 16) begin
			...
			if (WRITE_WIDTH_B != READ_WIDTH_B) begin
			    ...
			    if (READ_WIDTH_B != 0)
				$display("Functional warning at simulation time (%.3f ns) : X_ARAMB36_INTERNAL (%m) port B is in WRITE_FIRST mode with parameter WRITE_WIDTH_B = %d, which is different from READ_WIDTH_B = %d. The write will be successful however the read value of all bits on port B is unknown until the next CLKB cycle and all bits of WEB is set to all 1s or 0s.", $time/1000.0, WRITE_WIDTH_B, READ_WIDTH_B);    
	...
	case (DOA_REG)
	    ...
	    default : begin
	                  $display("Attribute Syntax Error : The attribute DOA_REG on X_ARAMB36_INTERNAL instance %m is set to %2d.  Legal values for this attribute are 0 or 1.", DOA_REG);
	                  $finish;
	              end
...
// ***** Output Registers **** Port B *****
	...
	case (DOB_REG)
	    ...
	    default : begin
	                  $display("Attribute Syntax Error : The attribute DOB_REG on X_ARAMB36_INTERNAL instance %m is set to %2d.  Legal values for this attribute are 0 or 1.", DOB_REG);
	                  $finish;
	              end
