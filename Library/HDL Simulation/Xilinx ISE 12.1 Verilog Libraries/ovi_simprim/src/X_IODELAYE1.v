...
//-----------------------------------------------------
    ...
    buf buf_c (c_in_pre, C);
    buf buf_ce (ce_in, CE);
    buf buf_cinvctrl (cinvctrl_in, CINVCTRL);
    buf buf_clkin (clkin_in, CLKIN);
    buf buf_cntvaluein [4:0] (cntvaluein_in, CNTVALUEIN);
    buf buf_datain (datain_in, DATAIN);
...
//    02/02/09 - Fixed CNTVALUEOUT for when in DEFAULT/FIXED mode. 
//   For simprims, the fixed Delay value is taken from the sdf.
...
//    02/02/09 - Fixed CNTVALUEOUT for when in DEFAULT/FIXED mode because of simprim. 
    ...
    initial begin
        ...
        case (SIGNAL_PATTERN)
            "CLOCK", "DATA" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute SIGNAL_PATTERN on X_IODELAYE1 instance %m is set to %s.  Legal values for this attribute are DATA or CLOCK.",  SIGNAL_PATTERN);
               $finish;
            end
        endcase
        ...
        case (HIGH_PERFORMANCE_MODE)
            "TRUE", "FALSE" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute HIGH_PERFORMANCE_MODE on X_IODELAYE1 instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",  HIGH_PERFORMANCE_MODE);
               $finish;
            end
        endcase
        ...
        if (IDELAY_TYPE != "DEFAULT" && IDELAY_TYPE != "FIXED" && IDELAY_TYPE != "VARIABLE" && IDELAY_TYPE != "VAR_LOADABLE") begin
            ...
            $display("Attribute Syntax Error : The attribute IDELAY_TYPE on X_IODELAYE1 instance %m is set to %s.  Legal values for this attribute are DEFAULT, FIXED, VARIABLE or VAR_LOADABLE", IDELAY_TYPE);
            $finish;
        ...
        if (IDELAY_VALUE < MIN_DELAY_COUNT || IDELAY_VALUE > MAX_DELAY_COUNT) begin
            $display("Attribute Syntax Error : The attribute IDELAY_VALUE on X_IODELAYE1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 3, .... or 31", IDELAY_VALUE);
            $finish;
        ...
        if (ODELAY_VALUE < MIN_DELAY_COUNT || ODELAY_VALUE > MAX_DELAY_COUNT) begin
            $display("Attribute Syntax Error : The attribute ODELAY_VALUE on X_IODELAYE1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 3, .... or 31", ODELAY_VALUE);
            $finish;
        ...
        if (REFCLK_FREQUENCY < MIN_REFCLK_FREQUENCYL || REFCLK_FREQUENCY > MAX_REFCLK_FREQUENCYH) begin
            $display("Attribute Syntax Error : The attribute REFCLK_FREQUENCY on X_IODELAYE1 instance %m is set to %f.  Legal values for this attribute are 175.0 to 225.0", REFCLK_FREQUENCY);
            $finish;
...
//*********************************************************
    ...
    always @(datain_in or idatain_in, odatain_in, t_in, clkin_in ) begin
        ...
        case (DELAY_SRC)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute DELAY_SRC on X_IODELAYE1 instance %m is set to %s.  Legal values for this attribute are I, O, CLKIN, IO or DATAIN", DELAY_SRC);
                          $finish;
                      end
...
//*** Timing Checks Start here
    ...
    specify
        ...
        ( C => CNTVALUEOUT[0]) = (100:100:100, 100:100:100);
        ( C => CNTVALUEOUT[1]) = (100:100:100, 100:100:100);
        ( C => CNTVALUEOUT[2]) = (100:100:100, 100:100:100);
        ( C => CNTVALUEOUT[3]) = (100:100:100, 100:100:100);
        ( C => CNTVALUEOUT[4]) = (100:100:100, 100:100:100);
        ( C => DATAOUT) = (0:0:0, 0:0:0);
        ( CINVCTRL => CNTVALUEOUT[0]) = (100:100:100, 100:100:100);
        ( CINVCTRL => CNTVALUEOUT[1]) = (100:100:100, 100:100:100);
        ( CINVCTRL => CNTVALUEOUT[2]) = (100:100:100, 100:100:100);
        ( CINVCTRL => CNTVALUEOUT[3]) = (100:100:100, 100:100:100);
        ( CINVCTRL => CNTVALUEOUT[4]) = (100:100:100, 100:100:100);
        ...
        ( T => CNTVALUEOUT[0]) = (100:100:100, 100:100:100);
        ( T => CNTVALUEOUT[1]) = (100:100:100, 100:100:100);
        ( T => CNTVALUEOUT[2]) = (100:100:100, 100:100:100);
        ( T => CNTVALUEOUT[3]) = (100:100:100, 100:100:100);
        ( T => CNTVALUEOUT[4]) = (100:100:100, 100:100:100);
        ( T => DATAOUT) = (100:100:100, 100:100:100);
        ...
        $setuphold (posedge C, posedge RST, 0:0:0, 0:0:0, notifier, , , c_in_pre, rst_in);
        $setuphold (posedge C, negedge RST, 0:0:0, 0:0:0, notifier, , , c_in_pre, rst_in);
        $setuphold (posedge C, posedge CNTVALUEIN[0], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[0]);
        $setuphold (posedge C, negedge CNTVALUEIN[0], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[0]);
        $setuphold (posedge C, posedge CNTVALUEIN[1], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[1]);
        $setuphold (posedge C, negedge CNTVALUEIN[1], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[1]);
        $setuphold (posedge C, posedge CNTVALUEIN[2], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[2]);
        $setuphold (posedge C, negedge CNTVALUEIN[2], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[2]);
        $setuphold (posedge C, posedge CNTVALUEIN[3], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[3]);
        $setuphold (posedge C, negedge CNTVALUEIN[3], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[3]);
        $setuphold (posedge C, posedge CNTVALUEIN[4], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[4]);
        $setuphold (posedge C, negedge CNTVALUEIN[4], 0:0:0, 0:0:0, notifier, , , c_in_pre, cntvaluein_in[4]);
