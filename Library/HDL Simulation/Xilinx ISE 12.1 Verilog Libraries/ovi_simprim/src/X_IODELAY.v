...
module X_IODELAY (DATAOUT, C, CE, DATAIN, IDATAIN, INC, ODATAIN, RST, T);
    ...
    parameter D_IODELAY_OFFSET = 0.0;
...
//   For simprims, the fixed/Default Delay values are taken from the sdf.
    ...
    initial begin
        ...
        case (SIGNAL_PATTERN)
            "CLOCK", "DATA" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute SIGNAL_PATTERN on X_IODELAY instance %m is set to %s.  Legal values for this attribute are DATA or CLOCK.",  SIGNAL_PATTERN);
               $finish;
            end
        endcase
        ...
        case (HIGH_PERFORMANCE_MODE)
            "TRUE", "FALSE" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute HIGH_PERFORMANCE_MODE on X_IODELAY instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",  HIGH_PERFORMANCE_MODE);
               $finish;
            end
        endcase
        ...
        if (IDELAY_TYPE != "DEFAULT" && IDELAY_TYPE != "FIXED" && IDELAY_TYPE != "VARIABLE") begin
            ...
            $display("Attribute Syntax Error : The attribute IDELAY_TYPE on X_IODELAY instance %m is set to %s.  Legal values for this attribute are DEFAULT, FIXED or VARIABLE", IDELAY_TYPE);
            $finish;
        ...
        if (IDELAY_VALUE < MIN_IDELAY_COUNT || IDELAY_VALUE > MAX_IDELAY_COUNT) begin
            $display("Attribute Syntax Error : The attribute IDELAY_VALUE on X_IODELAY instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 3, .... or 63", IDELAY_VALUE);
            $finish;
        ...
        if (ODELAY_VALUE < MIN_ODELAY_COUNT || ODELAY_VALUE > MAX_ODELAY_COUNT) begin
            $display("Attribute Syntax Error : The attribute ODELAY_VALUE on X_IODELAY instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 3, .... or 63", ODELAY_VALUE);
            $finish;
        ...
        if (REFCLK_FREQUENCY < MIN_REFCLK_FREQUENCY || REFCLK_FREQUENCY > MAX_REFCLK_FREQUENCY) begin
            $display("Attribute Syntax Error : The attribute REFCLK_FREQUENCY on X_IODELAY instance %m is set to %f.  Legal values for this attribute are 175.0 to 225.0", REFCLK_FREQUENCY);
            $finish;
...
//*********************************************************
    ...
    always @(datain_in or idatain_in, odatain_in, t_in ) begin
        ...
        case (DELAY_SRC)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute DELAY_SRC on X_IODELAY instance %m is set to %s.  Legal values for this attribute are I, O, IO or DATAIN", DELAY_SRC);
                          $finish;
                      end
...
//*** Timing Checks Start here
    ...
    specify
        ...
        (T => DATAOUT) = (0:0:0, 0:0:0);
       
        $setuphold (posedge C, posedge CE,  0:0:0, 0:0:0, notifier, , , c_in, ce_in);
        $setuphold (posedge C, negedge CE,  0:0:0, 0:0:0, notifier, , , c_in, ce_in);
        $setuphold (posedge C, posedge INC, 0:0:0, 0:0:0, notifier, , , c_in, inc_in);
        $setuphold (posedge C, negedge INC, 0:0:0, 0:0:0, notifier, , , c_in, inc_in);
        $setuphold (posedge C, posedge RST, 0:0:0, 0:0:0, notifier, , , c_in, rst_in);
        $setuphold (posedge C, negedge RST, 0:0:0, 0:0:0, notifier, , , c_in, rst_in);
