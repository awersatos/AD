// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/virtex4/X_DSP48.v,v 1.15 2008/08/20 23:55:23 fphillip Exp $
///////////////////////////////////////////////////////////////////////////////
	...
	case (LEGACY_MODE)
	    ...
	    "NONE", "MULT18X18" : ;
            "MULT18X18S" : if (MREG == 0) begin
			       $display("Attribute Syntax Error : The attribute LEGACY_MODE on X_DSP48 instance %m is set to %s.  This requires attribute MREG to be set to 1.", LEGACY_MODE);
			       $finish;
	                   end
	    default : begin
		          $display("Attribute Syntax Error : The attribute LEGACY_MODE on X_DSP48 instance %m is set to %s.  Legal values for this attribute are NONE, MULT18X18 or MULT18X18S.", LEGACY_MODE);
		          $finish;
	              end
...
//*** Input register C with 1 level deep of register
	...
	case (CREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Input register B with 2 level deep of registers
	...
	case (B_INPUT)
            ...
            "CASCADE" : b_o_mux <= bcin_in;
              default : begin
	       	            $display("Attribute Syntax Error : The attribute B_INPUT on X_DSP48 instance %m is set to %s.  Legal values for this attribute are DIRECT or CASCADE.", B_INPUT);
		            $finish;
                        end
	endcase
    end
	...
	case (BREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute BREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0, 1 or 2.", BREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Input register A with 2 level deep of registers
	...
	case (AREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute AREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0, 1 or 2.", AREG);
	                  $finish;
	              end
	endcase
    end
...
//*** 18x18 Multiplier
	...
	case (MREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute MREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", MREG);
	                  $finish;
	              end
	endcase
    end
...
//*** CarryInSel and OpMode with 1 level of register
	...
	case (CARRYINSELREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINSELREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINSELREG);
	                  $finish;
	              end
	endcase
    end
	...
	case (OPMODEREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute OPMODEREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", OPMODEREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Subtract with 1 level of register
	...
	case (SUBTRACTREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute SUBTRACTREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", SUBTRACTREG);
	                  $finish;
	              end
	endcase
    end
...
//
		...
		default : begin
				  ...
				  assign add_o = 48'bx;
				  $display("OPMODE Input Warning : The OPMODE %b to X_DSP48 instance %m is either invalid or the CARRYINSEL %b for that specific OPMODE is invalid at %.3f ns.", qopmode_o_mux, qcarryinsel_o_mux, $time/1000.0);
...
// ***  Adder
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48 instance %m at %.3f ns requires attribute MREG set to 0.", qopmode_o_mux, qcarryinsel_o_mux, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48 instance %m at %.3f ns requires attribute MREG set to 1.", qopmode_o_mux, qcarryinsel_o_mux, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b to X_DSP48 instance %m at %.3f ns requires attribute PREG set to 1.", qopmode_o_mux, $time/1000.0);
	    end
	end
...
//*** CarryIn Mux and Register
	...
	case (CARRYINREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Output register P with 1 level of register
	...
	case (PREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute PREG on X_DSP48 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", PREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Timing Checks Start here
    ...
    and (CarryinSel_enable, CEA, CEB, CECTRL, nrsta, nrstb, nrstctrl);
    and (Opmode_enable, CECTRL, nrstctrl);
    and (Sub_enable, CEA, CEB, nrsta, nrstb, nrstctrl);
	...
	(CARRYIN *> P) = (0:0:0, 0:0:0);
        ...
        (SUBTRACT *> P) = (0:0:0, 0:0:0);
        (SUBTRACT *> PCOUT) = (0:0:0, 0:0:0);
        (PCIN *> P) = (0:0:0, 0:0:0);
	...
	$setuphold (posedge CLK, posedge SUBTRACT &&& (Sub_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, subtract_in);
	$setuphold (posedge CLK, negedge SUBTRACT &&& (Sub_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, subtract_in);
	...
	$setuphold (posedge CLK, posedge CECINSUB, 0:0:0, 0:0:0, notifier, , , clk_in, cecinsub_in);
	$setuphold (posedge CLK, negedge CECINSUB, 0:0:0, 0:0:0, notifier, , , clk_in, cecinsub_in);
	...
	$setuphold (posedge CLK, posedge RSTCTRL, 0:0:0, 0:0:0, notifier, , , clk_in, rstctrl_in);
	$setuphold (posedge CLK, negedge RSTCTRL, 0:0:0, 0:0:0, notifier, , , clk_in, rstctrl_in);
