...
module X_OSERDESE1 (OCBEXTEND, OFB, OQ, SHIFTOUT1, SHIFTOUT2, TFB, TQ,
...
//-------------------------------------------------
        case (DATA_RATE_OQ)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute DATA_RATE_OQ on X_OSERDESE1 instance %m is set to %s.  Legal values for this attribute are SDR or DDR", DATA_RATE_OQ);
                          $finish;
                      end
...
//-------------------------------------------------
       case (DATA_RATE_TQ)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute DATA_RATE_TQ on X_OSERDESE1 instance %m is set to %s.  Legal values for this attribute are BUF, SDR or DDR", DATA_RATE_TQ);
                          $finish;
                      end
...
//-------------------------------------------------
        case (DATA_WIDTH)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute DATA_WIDTH on X_OSERDESE1 instance %m is set to %d.  Legal values for this attribute are 2, 3, 4, 5, 6, 7, 8, or 10", DATA_WIDTH);
                          $finish;
                      end
...
//-------------------------------------------------
        case (DDR3_DATA)
            ...
            default : begin 
                          $display("Attribute Syntax Error : The attribute DDR3_DATA on X_OSERDESE1 instance %m is set to %d.  Legal values for this attribute are 0 or 1", DDR3_DATA);
                          $finish;
                      end
...
//-------------------------------------------------
        case (INTERFACE_TYPE)
               ...
               default : begin
                          $display("Attribute Syntax Error : The attribute INTERFACE_TYPE on X_OSERDESE1 instance %m is set to %s.  Legal values for this attribute are DEFAULT, or MEMORY_DDR3", INTERFACE_TYPE);
                          $finish;
                         end
...
//            "TRUE"  : odelay_used_int <= 1'b1;
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute ODELAY_USED on X_OSERDESE1 instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", ODELAY_USED);
                          $finish;
                      end
...
//-------------------------------------------------
        case (SERDES_MODE)
            ...
            default  : begin
                          $display("Attribute Syntax Error : The attribute SERDES_MODE on X_OSERDESE1 instance %m is set to %s.  Legal values for this attribute are MASTER or SLAVE", SERDES_MODE);
                          $finish;
                      end
...
//-------------------------------------------------
        case (TRISTATE_WIDTH)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute TRISTATE_WIDTH on X_OSERDESE1 instance %m is set to %d.  Legal values for this attribute are 1, 2 or 4", TRISTATE_WIDTH);
                          $finish;
                      end
