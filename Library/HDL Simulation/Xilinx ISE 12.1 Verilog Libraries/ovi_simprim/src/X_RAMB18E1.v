// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/blanc/X_RAMB18E1.v,v 1.14.36.1 2010/03/29 22:41:37 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module X_RAMB18E1 (DOADO, DOBDO, DOPADOP, DOPBDOP,
    ...
    integer finish_error = 0;
    integer ram_mode_int = 0;
	...
	if (RAM_MODE == "SDP") begin
		...
		$display("DRC Error : The attribute WRITE_MODE_A on X_RAMB18E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_A);
		finish_error = 1;
	    end
	    
		
	    if (WRITE_MODE_B != "READ_FIRST") begin
		$display("DRC Error : The attribute WRITE_MODE_B on X_RAMB18E1 instance %m is set to %s.  It must set to READ_FIRST when RAM_MODE = SDP.", WRITE_MODE_B);
		finish_error = 1;
	    end
...
//*** Timing Checks Start here
    ...
    wire diadi0_enable = (ram_mode_int == 0) && ENARDEN && WEA[0];
    wire diadi1_enable = (ram_mode_int == 0) && ENARDEN && WEA[1];

    wire dibdi0_enable = (ram_mode_int == 0) ? (ENBWREN && WEBWE[0]) : (ENBWREN && WEBWE[2]) ;
    wire dibdi1_enable = (ram_mode_int == 0) ? (ENBWREN && WEBWE[1]) : (ENBWREN && WEBWE[3]) ;
    
    wire sdp_dia0_clkwr = (ram_mode_int == 1) && ENBWREN && WEBWE[0];
    wire sdp_dia1_clkwr = (ram_mode_int == 1) && ENBWREN && WEBWE[1];
    ...
    specify
        ...
        (CLKARDCLK => DOADO[0]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[1]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[2]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[3]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[4]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[5]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[6]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[7]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[8]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[9]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[10]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[11]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[12]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[13]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[14]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOADO[15]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOPADOP[0]) = (100:100:100, 100:100:100);
        (CLKARDCLK => DOPADOP[1]) = (100:100:100, 100:100:100);
       	if (ram_mode_int == 1) (CLKARDCLK => DOBDO[0]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[1]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[2]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[3]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[4]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[5]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[6]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[7]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[8]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[9]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[10]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[11]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[12]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[13]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[14]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOBDO[15]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOPBDOP[0]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 1) (CLKARDCLK => DOPBDOP[1]) = (100:100:100, 100:100:100);

	if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[0]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[1]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[2]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[3]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[4]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[5]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[6]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[7]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[8]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[9]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[10]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[11]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[12]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[13]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[14]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOBDO[15]) = (100:100:100, 100:100:100);
	if (ram_mode_int == 0) (CLKBWRCLK => DOPBDOP[0]) = (100:100:100, 100:100:100);
        if (ram_mode_int == 0) (CLKBWRCLK => DOPBDOP[1]) = (100:100:100, 100:100:100);
	
	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[0] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra0);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[0] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra0);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[1] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra1);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[1] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra1);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[2] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra2);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[2] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra2);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[3] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra3);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[3] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra3);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[4] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra4);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[4] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra4);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[5] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra5);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[5] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra5);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[6] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra6);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[6] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra6);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[7] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra7);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[7] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra7);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[8] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra8);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[8] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra8);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[9] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra9);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[9] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra9);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[10] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra10);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[10] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra10);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[11] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra11);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[11] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra11);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[12] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra12);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[12] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra12);
       	$setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[13] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra13);
       	$setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[13] &&& ENARDEN, 0:0:0, 0:0:0, notifier_addra13);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[0] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[0] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[1] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[1] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[2] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[2] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[3] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[3] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[4] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[4] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[5] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[5] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[6] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[6] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[7] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[7] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[8] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[8] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[9] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[9] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[10] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[10] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[11] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[11] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[12] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[12] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[13] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[13] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[14] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[14] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIADI[15] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIADI[15] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIPADIP[0] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIPADIP[0] &&& diadi0_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge DIPADIP[1] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge DIPADIP[1] &&& diadi1_enable, 0:0:0, 0:0:0, notifier_a);
	...
	$setuphold (posedge CLKARDCLK, posedge REGCEAREGCE, 0:0:0, 0:0:0, notifier_a);
       	...
       	$setuphold (posedge CLKARDCLK, posedge WEA[0] &&& ENARDEN, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge WEA[0] &&& ENARDEN, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, posedge WEA[1] &&& ENARDEN, 0:0:0, 0:0:0, notifier_a);
       	$setuphold (posedge CLKARDCLK, negedge WEA[1] &&& ENARDEN, 0:0:0, 0:0:0, notifier_a);
	
	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[0] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb0);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[0] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb0);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[1] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb1);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[1] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb1);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[2] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb2);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[2] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb2);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[3] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb3);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[3] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb3);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[4] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb4);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[4] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb4);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[5] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb5);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[5] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb5);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[6] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb6);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[6] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb6);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[7] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb7);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[7] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb7);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[8] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb8);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[8] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb8);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[9] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb9);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[9] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb9);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[10] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb10);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[10] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb10);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[11] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb11);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[11] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb11);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[12] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb12);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[12] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb12);
       	$setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[13] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb13);
       	$setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[13] &&& ENBWREN, 0:0:0, 0:0:0, notifier_addrb13);
	$setuphold (posedge CLKBWRCLK, posedge DIADI[0] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
	$setuphold (posedge CLKBWRCLK, negedge DIADI[0] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[1] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[1] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[2] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[2] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[3] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[3] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[4] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[4] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[5] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[5] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[6] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[6] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[7] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[7] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[8] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[8] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[9] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[9] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[10] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[10] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[11] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[11] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[12] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[12] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[13] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[13] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[14] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[14] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIADI[15] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIADI[15] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIPADIP[0] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIPADIP[0] &&& sdp_dia0_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIPADIP[1] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIPADIP[1] &&& sdp_dia1_clkwr, 0:0:0, 0:0:0, notifier_b);
	$setuphold (posedge CLKBWRCLK, posedge DIBDI[0] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
	$setuphold (posedge CLKBWRCLK, negedge DIBDI[0] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[1] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[1] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[2] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[2] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[3] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[3] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[4] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[4] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[5] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[5] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[6] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[6] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[7] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[7] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[8] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[8] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[9] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[9] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[10] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[10] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[11] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[11] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[12] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[12] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[13] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[13] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[14] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[14] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIBDI[15] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIBDI[15] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
	$setuphold (posedge CLKBWRCLK, posedge DIPBDIP[0] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIPBDIP[0] &&& dibdi0_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge DIPBDIP[1] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge DIPBDIP[1] &&& dibdi1_enable, 0:0:0, 0:0:0, notifier_b);
	...
	$setuphold (posedge CLKBWRCLK, posedge RSTREGB, 0:0:0, 0:0:0, notifier_b);
       	...
       	$setuphold (posedge CLKBWRCLK, posedge WEBWE[0] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge WEBWE[0] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge WEBWE[1] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge WEBWE[1] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge WEBWE[2] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge WEBWE[2] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, posedge WEBWE[3] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
       	$setuphold (posedge CLKBWRCLK, negedge WEBWE[3] &&& ENBWREN, 0:0:0, 0:0:0, notifier_b);
...
// xilinx_internal_parameter off
    ...
    reg [7:0] no_col = 8'b0;
    reg rstreg_priority_a_int, rstreg_priority_b_int;
    reg [8:0] rdaddrecc_out = 9'b0, rdaddrecc_outreg = 9'b0;
    reg [8:0] rdaddrecc_out_out = 9'b0;
    reg ram_mode_int, en_ecc_write_int, en_ecc_read_int;
    reg finish_error = 0;
...
//	    if ((SIM_COLLISION_CHECK == "ALL" || SIM_COLLISION_CHECK == "WARNING_ONLY") && !(((wr_mode_b == 2'b01 && web_tmp === 1'b1 && wea_tmp === 1'b0) && (!(rising_clka && !rising_clkb) || viol_time == 1)) || ((wr_mode_a == 2'b01 && wea_tmp === 1'b1 && web_tmp === 1'b0) && (!(rising_clkb && !rising_clka) || viol_time == 1))))
	    if ((SIM_COLLISION_CHECK == "ALL" || SIM_COLLISION_CHECK == "WARNING_ONLY") && !(((wr_mode_b == 2'b01 && web_tmp === 1'b1 && wea_tmp === 1'b0) && viol_time == 1) || ((wr_mode_a == 2'b01 && wea_tmp === 1'b1 && web_tmp === 1'b0) && viol_time == 1)))
