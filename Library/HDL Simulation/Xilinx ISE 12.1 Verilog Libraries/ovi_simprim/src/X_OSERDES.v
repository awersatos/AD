...
// Tristate output
	...
	case (SERDES_MODE)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute SERDES_MODE on X_OSERDES instance %m is set to %s.  Legal values for this attribute are MASTER or SLAVE", SERDES_MODE);
		          $finish;
                      end
	...
	case (DATA_RATE_OQ)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute DATA_RATE_OQ on X_OSERDES instance %m is set to %s.  Legal values for this attribute are SDR or DDR", DATA_RATE_OQ);
		          $finish;
                      end
	...
	case (DATA_WIDTH)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute DATA_WIDTH on X_OSERDES instance %m is set to %d.  Legal values for this attribute are 2, 3, 4, 5, 6, 7, 8, or 10", DATA_WIDTH);
		          $finish;
                      end
	...
	case (DATA_RATE_TQ)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute DATA_RATE_TQ on X_OSERDES instance %m is set to %s.  Legal values for this attribute are BUF, SDR or DDR", DATA_RATE_TQ);
		          $finish;
                      end
	...
	case (TRISTATE_WIDTH)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute TRISTATE_WIDTH on X_OSERDES instance %m is set to %d.  Legal values for this attribute are 1, 2 or 4", TRISTATE_WIDTH);
		          $finish;
                      end
...
// CR 458156 -- allow/enabled TRISTATE_WIDTH to be 1 in DDR mode. No func change, but removed warnings
	    ...
	    5'bX1000: ;
	    default: begin
		         $display("DATA_RATE_TQ %s and/or TRISTATE_WIDTH %d at time %t ns are not supported by X_OSERDES", DATA_RATE_TQ, TRISTATE_WIDTH, $time/1000.0);
	                 $finish;
	             end
