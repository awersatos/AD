...
module X_BUFIO2_2CLK (DIVCLK, IOCLK, SERDESSTROBE, I, IB);
...
//------------------------  Output Ports  ------------------------------
//----------------------------------------------------------------------
    buf buf_divclk(DIVCLK, divclk_out);
    buf buf_ioclk(IOCLK, ioclk_out);
    buf buf_iserdesstrobe(SERDESSTROBE, serdesstrobe_out);
...
//                end   
	    ...
	    2 : begin
            ...
            default : begin
                      $display("Attribute Syntax Error : The attribute DIVIDE on X_BUFIO2_2CLK instance %m is set to %d.  Legal values for this attribute are 2, 3, 4, 5, 6, 7 or 8.", DIVIDE);
                      attr_err_flag = 1;
                      end
        endcase // (DIVIDE)
...
// CR 531517 added I_INVERT
    generate if  (I_INVERT == "TRUE")
       begin
...
//*** Timing Checks Start here
    specify
      ( I => DIVCLK) = (100:100:100, 100:100:100);
      ( I => IOCLK) = (0:0:0, 0:0:0);
      ( I => SERDESSTROBE) = (100:100:100, 100:100:100);
      ( IB => DIVCLK) = (100:100:100, 100:100:100);
      ( IB => IOCLK) = (0:0:0, 0:0:0);
      ( IB => SERDESSTROBE) = (100:100:100, 100:100:100);

      specparam PATHPULSE$ = 0;
    endspecify

endmodule // X_BUFIO2_2CLK
