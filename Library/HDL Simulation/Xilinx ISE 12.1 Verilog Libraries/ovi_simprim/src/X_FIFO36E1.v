// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/blanc/X_FIFO36E1.v,v 1.13 2009/12/03 02:15:00 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module X_FIFO36E1 (ALMOSTEMPTY, ALMOSTFULL, DBITERR, DO, DOP, ECCPARITY, EMPTY, FULL, RDCOUNT, RDERR, SBITERR, WRCOUNT, WRERR,
    ...
    specify
        ...
        (RDCLK => DO[32]) = (100:100:100, 100:100:100);
        (RDCLK => DO[33]) = (100:100:100, 100:100:100);
        (RDCLK => DO[34]) = (100:100:100, 100:100:100);
        (RDCLK => DO[35]) = (100:100:100, 100:100:100);
        (RDCLK => DO[36]) = (100:100:100, 100:100:100);
        (RDCLK => DO[37]) = (100:100:100, 100:100:100);
        (RDCLK => DO[38]) = (100:100:100, 100:100:100);
        (RDCLK => DO[39]) = (100:100:100, 100:100:100);
        (RDCLK => DO[40]) = (100:100:100, 100:100:100);
	(RDCLK => DO[41]) = (100:100:100, 100:100:100);
        (RDCLK => DO[42]) = (100:100:100, 100:100:100);
        (RDCLK => DO[43]) = (100:100:100, 100:100:100);
        (RDCLK => DO[44]) = (100:100:100, 100:100:100);
        (RDCLK => DO[45]) = (100:100:100, 100:100:100);
        (RDCLK => DO[46]) = (100:100:100, 100:100:100);
        (RDCLK => DO[47]) = (100:100:100, 100:100:100);
        (RDCLK => DO[48]) = (100:100:100, 100:100:100);
        (RDCLK => DO[49]) = (100:100:100, 100:100:100);
        (RDCLK => DO[50]) = (100:100:100, 100:100:100);
	(RDCLK => DO[51]) = (100:100:100, 100:100:100);
        (RDCLK => DO[52]) = (100:100:100, 100:100:100);
        (RDCLK => DO[53]) = (100:100:100, 100:100:100);
        (RDCLK => DO[54]) = (100:100:100, 100:100:100);
        (RDCLK => DO[55]) = (100:100:100, 100:100:100);
        (RDCLK => DO[56]) = (100:100:100, 100:100:100);
        (RDCLK => DO[57]) = (100:100:100, 100:100:100);
        (RDCLK => DO[58]) = (100:100:100, 100:100:100);
        (RDCLK => DO[59]) = (100:100:100, 100:100:100);
        (RDCLK => DO[60]) = (100:100:100, 100:100:100);
	(RDCLK => DO[61]) = (100:100:100, 100:100:100);
        (RDCLK => DO[62]) = (100:100:100, 100:100:100);
        (RDCLK => DO[63]) = (100:100:100, 100:100:100);
        ...
        (RDCLK => DOP[4]) = (100:100:100, 100:100:100);
        (RDCLK => DOP[5]) = (100:100:100, 100:100:100);
        (RDCLK => DOP[6]) = (100:100:100, 100:100:100);
        (RDCLK => DOP[7]) = (100:100:100, 100:100:100);
	...
	(RDCLK => RDCOUNT[12]) = (100:100:100, 100:100:100);
	...
	(WRCLK => WRCOUNT[12]) = (100:100:100, 100:100:100);
	(WRCLK => WRERR) = (100:100:100, 100:100:100);
	(WRCLK => ECCPARITY[0]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[1]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[2]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[3]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[4]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[5]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[6]) = (100:100:100, 100:100:100);
        (WRCLK => ECCPARITY[7]) = (100:100:100, 100:100:100);
	...
	$setuphold (posedge WRCLK, negedge DIP[4] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DIP[5] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DIP[6] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DIP[7] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	...
	$setuphold (posedge WRCLK, negedge DI[32] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[33] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[34] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[35] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[36] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[37] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[38] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[39] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[40] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[41] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[42] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[43] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[44] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[45] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[46] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[47] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[48] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[49] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[50] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[51] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[52] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[53] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[54] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[55] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[56] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[57] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[58] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[59] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[60] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[61] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[62] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, negedge DI[63] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	...
	$setuphold (posedge WRCLK, posedge DIP[4] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DIP[5] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DIP[6] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DIP[7] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	...
	$setuphold (posedge WRCLK, posedge DI[32] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[33] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[34] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[35] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[36] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[37] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[38] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[39] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[40] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[41] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[42] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[43] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[44] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[45] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[46] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[47] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[48] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[49] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[50] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[51] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[52] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[53] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[54] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[55] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[56] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[57] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[58] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[59] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[60] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[61] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[62] &&& (wren_enable!=0), 0:0:0, 0:0:0);
	$setuphold (posedge WRCLK, posedge DI[63] &&& (wren_enable!=0), 0:0:0, 0:0:0);
...
// xilinx_internal_parameter off
    ...
    always @(rst_in or rden_in or wren_in) begin
        if (rst_in ==1 && rden_in==1 )
            $display("Warning : At time %t,  RDEN on X_FF36_INTERNAL_VLOG instance %m is high when RST is high. RDEN should be low during reset.", $stime);
        if (rst_in ==1 && wren_in ==1)
            $display("Warning : At time %t,  WREN on X_FF36_INTERNAL_VLOG instance %m is high when RST is high. WREN should be low during reset.", $stime);
    end
	...
	if (rst_tmp1 == 0 && rst_tmp2 == 1) begin
		...
		$display("Error : At time %t,  RST high on X_FF36_INTERNAL_VLOG instance %m is short than three RDCLK clock cycles. RST high need be more that three RDCLK clock cycles.", $stime);
		rst_rdclk_flag = 1;
	    end

            if ((rst_wrckreg[2] & rst_wrckreg[1] & rst_wrckreg[0]) == 0) begin
		$display("Error : At time %t,  RST high on X_FF36_INTERNAL_VLOG instance %m is short than three WRCLK clock cycles. RST high need be more that three WRCLK clock cycles.", $stime);
		rst_wrclk_flag = 1;
	    end
