...
module X_IBUFDS_GTXE1 (O, ODIV2, CEB, I, IB);
...
//-------------------------------------------------
        case (CLKCM_CFG)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CLKCM_CFG on X_IBUFDS_GTXE1 instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", CLKCM_CFG);
                          $finish;
                      end
...
//-------------------------------------------------
        case (CLKRCV_TRST)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CLKRCV_TRST on X_IBUFDS_GTXE1 instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", CLKRCV_TRST);
                          $finish;
                      end
