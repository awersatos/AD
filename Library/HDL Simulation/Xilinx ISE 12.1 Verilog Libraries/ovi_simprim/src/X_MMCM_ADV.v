// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/blanc/X_MMCM_ADV.v,v 1.45.2.1 2010/03/22 18:57:09 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
        ...
        if (dwe_in == 1) begin          // write process
          ...
          (daddr_in >= 7'b0000110 && daddr_in <= 7'b0010110))) begin
             ...
             if (daddr_in == 7'b0010100) begin
               ...
               if (clkfbtmp_divi > 64 || (clkind_divi < 5))
                  $display(" Input Error : DI at Address DADDR=%b is %h at X_MMCM_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %d and over the range of %d to %d.",  daddr_in, di_in, clkind_divi, $time, 5, 64);
            end
