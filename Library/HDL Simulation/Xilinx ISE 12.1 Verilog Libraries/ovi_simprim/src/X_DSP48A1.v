...
module X_DSP48A1 (BCOUT, CARRYOUT, CARRYOUTF, M, P, PCOUT, A, B, BCIN, C, CARRYIN, CEA, CEB, CEC, CECARRYIN, CED, CEM, CEOPMODE, CEP, CLK, D, OPMODE, PCIN, RSTA, RSTB, RSTC, RSTCARRYIN, RSTD, RSTM, RSTOPMODE, RSTP); 
...
//----------------------------------------------------------------------
    ...
    buf b_carryoutf (CARRYOUTF, carryout_x_o);
    buf b_m_o[MSB_M:0] (M, qmult_o_mux);
...
//-----------------------------------------------------
    ...
    initial begin
        case (B_INPUT)
             "DIRECT" : B_INPUT_flag <= b_in;
            "CASCADE" : B_INPUT_flag <= bcin_in;
              default : begin
                            $display("Attribute Syntax Error : The attribute B_INPUT on X_DSP48A1 instance %m is set to %s. Legal values for this attribute are DIRECT or CASCADE.", B_INPUT);
                            $finish;
                        end
        endcase
    end
...
//-------- A0REG/A1REG  & B0REG/B1REG ------
        ...
        if ((A0REG != 0) && (A0REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute A0REG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", A0REG);
	  $finish;
        end    

        if ((A1REG != 0) && (A1REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute A1REG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", A1REG);
	  $finish;
        end    

        if ((B0REG != 0) && (B0REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute B0REG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", B0REG);
	  $finish;
        end    

        if ((B1REG != 0) && (B1REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute B1REG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", B1REG);
	  $finish;
        end    
...
//-------- RSTTYPE ------
	...
	case (RSTTYPE)
	  ...
	  default : begin
		          $display("Attribute Syntax Error : The attribute RSTTYPE on X_DSP48A1 instance %m is set to %s.  Legal values for this attribute are SYNC or ASYNC.", RSTTYPE);
		          $finish;
	              end
	endcase
...
//-------- CARRYINSEL ------
        ...
        case (CARRYINSEL)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CARRYINSEL on X_DSP48A1 instance %m is set to %s.  Legal valuesfor this attribute are CARRYIN or OPMODE5.", CARRYINSEL);
                          $finish;
                      end
        endcase
...
//*** PRE_ADD 
    always @(qopmode_o_mux, b_o_mux, qd_o_mux, qb_o_reg1) begin
...
// Synchronous Operation
	...
	case (CREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (DREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute DREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", DREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (MREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute MREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", MREG);
	                  $finish;
	              end
	endcase
    end
...
//---------------------------------------------------- 
	...
	case (CARRYINSEL)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINSEL on X_DSP48A1 instance %m is set to %s.  Legal values for this attribute are CARRYIN or OPMODE5.", CARRYINSEL);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (CARRYINREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (OPMODEREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute OPMODEREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", OPMODEREG);
	                  $finish;
	              end
	endcase
    end
...
//---------------------------------------------------- 
	...
	case (CARRYOUTREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYOUTREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", OPMODEREG);
	                  $finish;
	              end
	endcase
    end
            ...
            case ({qopmode_o_mux, carryinsel_attr})
                ...
                default : begin
                              if (invalid_opmode) begin
                                  ...
                                  assign add_o    = 48'bx;
                                  $display("OPMODE Input Warning : The OPMODE %b to X_DSP48A1 instance %m is either invalid or the CARRYINSEL %b for that specific OPMODE at %.3f ns.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
...
//----------------------------------------------------
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48A1 instance %m at %.3f ns requires attribute MREG set to 0.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48A1 instance %m at %.3f ns requires attribute MREG set to 1.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b to X_DSP48A1 instance %m at %.3f ns requires attribute PREG set to 1.", qopmode_o_mux, $time/1000.0);
	    end
	end
...
// Synchronous Operation
	...
	case (PREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute PREG on X_DSP48A1 instance %m is set to %d.  Legal values for this attribute are 0 or 1.", PREG);
	                  $finish;
	              end
	endcase
    end
...
//*** Timing Checks Start here
    ...
    not (nrstb, RSTB);
    not (nrstc, RSTC);
    not (nrstcarryin, RSTCARRYIN);
    not (nrstd, RSTD);
    not (nrstm, RSTM);
    not (nrstopmode, RSTOPMODE);
    not (nrstp, RSTP);

    and (carryin_enable, CEA, CEB, CECARRYIN, nrsta, nrstb, nrstcarryin);
    and (Opmode_enable, CEOPMODE, nrstopmode);
    ...
    specify
        ...
        $setuphold (posedge CLK, posedge B &&& (b_bcin_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, b_in);
        $setuphold (posedge CLK, negedge B &&& (b_bcin_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, b_in);
        $setuphold (posedge CLK, posedge BCIN &&& (b_bcin_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, bcin_in);
        $setuphold (posedge CLK, negedge BCIN &&& (b_bcin_enable!=0), 0:0:0, 0:0:0, notifier, , , clk_in, bcin_in);
        ...
        $setuphold (posedge CLK, posedge CEA &&& (RSTA==0), 0:0:0, 0:0:0, notifier, , , clk_in, cea_in);
        $setuphold (posedge CLK, negedge CEA &&& (RSTA==0), 0:0:0, 0:0:0, notifier, , , clk_in, cea_in);
        $setuphold (posedge CLK, posedge CEB &&& (RSTB==0), 0:0:0, 0:0:0, notifier, , , clk_in, ceb_in);
        $setuphold (posedge CLK, negedge CEB &&& (RSTB==0), 0:0:0, 0:0:0, notifier, , , clk_in, ceb_in);
        ...
        $setuphold (posedge CLK, posedge CECARRYIN &&& (RSTCARRYIN==0), 0:0:0, 0:0:0, notifier, , , clk_in, cecarryin_in);
        $setuphold (posedge CLK, negedge CECARRYIN &&& (RSTCARRYIN==0), 0:0:0, 0:0:0, notifier, , , clk_in, cecarryin_in);
        $setuphold (posedge CLK, posedge CEOPMODE &&& (RSTOPMODE==0), 0:0:0, 0:0:0, notifier, , , clk_in, ceopmode_in);
        $setuphold (posedge CLK, negedge CEOPMODE &&& (RSTOPMODE==0), 0:0:0, 0:0:0, notifier, , , clk_in, ceopmode_in);
        ...
        $setuphold (posedge CLK, posedge RSTA, 0:0:0, 0:0:0, notifier, , , clk_in, rsta_in);


        $setuphold (posedge CLK, posedge RSTA, 0:0:0, 0:0:0, notifier, , , clk_in, rsta_in);
        $setuphold (posedge CLK, negedge RSTA, 0:0:0, 0:0:0, notifier, , , clk_in, rsta_in);
        $setuphold (posedge CLK, posedge RSTB, 0:0:0, 0:0:0, notifier, , , clk_in, rstb_in);
        $setuphold (posedge CLK, negedge RSTB, 0:0:0, 0:0:0, notifier, , , clk_in, rstb_in);
        $setuphold (posedge CLK, posedge RSTC, 0:0:0, 0:0:0, notifier, , , clk_in, rstc_in);
        $setuphold (posedge CLK, negedge RSTC, 0:0:0, 0:0:0, notifier, , , clk_in, rstc_in);
        $setuphold (posedge CLK, posedge RSTCARRYIN, 0:0:0, 0:0:0, notifier, , , clk_in, rstcarryin_in);
        $setuphold (posedge CLK, negedge RSTCARRYIN, 0:0:0, 0:0:0, notifier, , , clk_in, rstcarryin_in);
        $setuphold (posedge CLK, posedge RSTD, 0:0:0, 0:0:0, notifier, , , clk_in, rstd_in);
        $setuphold (posedge CLK, negedge RSTD, 0:0:0, 0:0:0, notifier, , , clk_in, rstd_in);
        $setuphold (posedge CLK, posedge RSTM, 0:0:0, 0:0:0, notifier, , , clk_in, rstm_in);
        $setuphold (posedge CLK, negedge RSTM, 0:0:0, 0:0:0, notifier, , , clk_in, rstm_in);
        $setuphold (posedge CLK, posedge RSTOPMODE, 0:0:0, 0:0:0, notifier, , , clk_in, rstopmode_in);
        $setuphold (posedge CLK, negedge RSTOPMODE, 0:0:0, 0:0:0, notifier, , , clk_in, rstopmode_in);
        $setuphold (posedge CLK, posedge RSTP, 0:0:0, 0:0:0, notifier, , , clk_in, rstp_in);
        $setuphold (posedge CLK, negedge RSTP, 0:0:0, 0:0:0, notifier, , , clk_in, rstp_in);

// Asynchronous
        $recrem (negedge RSTA, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTB, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTC, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTCARRYIN, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTD, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTM, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTOPMODE, posedge CLK, 0:0:0, 0:0:0, notifier);
        $recrem (negedge RSTP, posedge CLK, 0:0:0, 0:0:0, notifier);
