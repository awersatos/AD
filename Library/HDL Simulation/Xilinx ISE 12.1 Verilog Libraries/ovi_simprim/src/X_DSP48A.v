...
//-------- A0REG/A1REG  & B0REG/B1REG ------
        ...
        if ((A0REG != 0) && (A0REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute A0REG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", A0REG);
	  $finish;
        end    

        if ((A1REG != 0) && (A1REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute A1REG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", A1REG);
	  $finish;
        end    

        if ((B0REG != 0) && (B0REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute B0REG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", B0REG);
	  $finish;
        end    

        if ((B1REG != 0) && (B1REG != 1))
        begin 
	  $display("Attribute Syntax Error : The attribute B1REG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", B1REG);
	  $finish;
        end    
...
//-------- RSTTYPE ------
	...
	case (RSTTYPE)
	  ...
	  default : begin
		          $display("Attribute Syntax Error : The attribute RSTTYPE on X_DSP48A instance %m is set to %s.  Legal values for this attribute are SYNC or ASYNC.", RSTTYPE);
		          $finish;
	              end
	endcase
    ...
    always @(bcin_in or b_in) begin
        case (B_INPUT)
            ...
            "CASCADE" : b_o_mux <= bcin_in;
              default : begin
                            $display("Attribute Syntax Error : The attribute B_INPUT on X_DSP48A instance %m is set to %s. Legal values for this attribute are DIRECT or CASCADE.", B_INPUT);
                            $finish;
                        end
        endcase
    end
...
// Synchronous Operation
	...
	case (CREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (DREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute DREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", DREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (MREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute MREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", MREG);
	                  $finish;
	              end
	endcase
    end
...
//---------------------------------------------------- 
	...
	case (CARRYINSEL)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINSEL on X_DSP48A instance %m is set to %s.  Legal values for this attribute are CARRYIN or OPMODE5.", CARRYINSEL);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (CARRYINREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINREG);
	                  $finish;
	              end
	endcase
    end
...
// Synchronous Operation
	...
	case (OPMODEREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute OPMODEREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", OPMODEREG);
	                  $finish;
	              end
	endcase
    end
            ...
            case ({qopmode_o_mux, carryinsel_attr})
                ...
                default : begin
                              if (invalid_opmode) begin
                                  ...
                                  assign add_o    = 48'bx;
                                  $display("OPMODE Input Warning : The OPMODE %b to X_DSP48A instance %m is either invalid or the CARRYINSEL %b for that specific OPMODE at %.3f ns.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
...
//----------------------------------------------------
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48A instance %m at %.3f ns requires attribute MREG set to 0.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48A instance %m at %.3f ns requires attribute MREG set to 1.", qopmode_o_mux, carryinsel_attr, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign add_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b to X_DSP48A instance %m at %.3f ns requires attribute PREG set to 1.", qopmode_o_mux, $time/1000.0);
	    end
	end
...
// Synchronous Operation
	...
	case (PREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute PREG on X_DSP48A instance %m is set to %d.  Legal values for this attribute are 0 or 1.", PREG);
	                  $finish;
	              end
	endcase
    end
