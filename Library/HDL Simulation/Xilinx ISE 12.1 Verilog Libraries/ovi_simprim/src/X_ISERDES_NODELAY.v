...
//    05/29/06 - CR 232324 -- Added Rec/Rem RST wrt negedge CLK
//    06/15/06 - Added new port CLKB
...
// end_simprim_only
    ...
    reg serdes_mode_int, data_rate_int, bitslip_enable_int, ofb_used_int, tfb_used_int =0;
...
//----------------------------------------------------------------------------------- 
	...
	case (SERDES_MODE)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute SERDES_MODE on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are MASTER or SLAVE", SERDES_MODE);
		          $finish;
                      end
	...
	case (DATA_RATE)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute DATA_RATE on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are SDR or DDR", DATA_RATE);
		          $finish;
                      end
	...
	case (BITSLIP_ENABLE)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute BITSLIP_ENABLE on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", BITSLIP_ENABLE);
		          $finish;
                      end
	...
	case (DATA_WIDTH)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute DATA_WIDTH on X_ISERDES_NODELAY instance %m is set to %d.  Legal values for this attribute are 2, 3, 4, 5, 6, 7, 8, or 10", DATA_WIDTH);
		          $finish;
                      end
	...
	case (NUM_CE)
	    ...
	    2 : num_ce_int <= 1'b1;
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute NUM_CE on X_ISERDES_NODELAY instance %m is set to %d.  Legal values for this attribute are 1 or 2", NUM_CE);
		          $finish;
                      end
	...
	case (OFB_USED)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute OFB_USED on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", OFB_USED);
		          $finish;
                      end
...
//	case (TFB_USED)
//
//	    "FALSE" : tfb_used_int <= 1'b0;
//	    "TRUE"  : tfb_used_int <= 1'b1;
//	    default : begin
//	       	          $display("Attribute Syntax Error : The attribute TFB_USED on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", TFB_USED);
//		          $finish;
 //                     end
//
//	endcase // case(TFB_USED)
    ...
    assign feedback = {tfb_in, ofb_used_int, tfb_used_int};
...
// Mux to O and o_delay
	...
	case (IOBDELAY)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute IOBDELAY on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are NONE, IBUF, IFD or BOTH", IOBDELAY);
		          $finish;
                      end
...
//CR 422392 
///////////////////////////////////////////////////////
//  Muxing of D, OFB and TFB
//////////////////////////////////////////////////////

always @ (o_out_pre_fb or o_delay_pre_fb or ofb_in or feedback)
        begin
        casex (feedback)
        3'bX00: 
              begin
                o_out   <= o_out_pre_fb;
                o_delay <= o_delay_pre_fb;
              end
        3'bX01:
              begin
                o_out   <= o_out_pre_fb;
...
// 4 clock muxs in first rank
	...
	case (INTERFACE_TYPE)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute INTERFACE_TYPE on X_ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are MEMORY or NETWORKING", INTERFACE_TYPE);
		          $finish;
                      end
...
//-- SYNC
	$setuphold (posedge CLK, posedge RST, 0:0:0, 0:0:0,    notifier, , , clk_in, sr_in);
	$setuphold (posedge CLK, negedge RST, 0:0:0, 0:0:0,    notifier, , , clk_in, sr_in);
	$setuphold (posedge CLKB, posedge RST, 0:0:0, 0:0:0,   notifier, , , clkb_in, sr_in);
	$setuphold (posedge CLKB, negedge RST, 0:0:0, 0:0:0,   notifier, , , clkb_in, sr_in);
	$setuphold (posedge CLKDIV, posedge RST, 0:0:0, 0:0:0, notifier, , , clkdiv_in, sr_in);
	$setuphold (posedge CLKDIV, negedge RST, 0:0:0, 0:0:0, notifier, , , clkdiv_in, sr_in);
	$setuphold (posedge OCLK, posedge RST, 0:0:0, 0:0:0,   notifier, , , oclk_in, sr_in);
	$setuphold (posedge OCLK, negedge RST, 0:0:0, 0:0:0,   notifier, , , oclk_in, sr_in);
	$setuphold (negedge OCLK, posedge RST, 0:0:0, 0:0:0,   notifier, , , oclk_in, sr_in);
	$setuphold (negedge OCLK, negedge RST, 0:0:0, 0:0:0,   notifier, , , oclk_in, sr_in);

//-- ASYNC
	$recrem (negedge RST, posedge CLK, 0:0:0, 0:0:0, notifier);
	$recrem (negedge RST, posedge CLKB, 0:0:0, 0:0:0, notifier);
	$recrem (negedge RST, posedge CLKDIV, 0:0:0, 0:0:0, notifier);
	$recrem (negedge RST, posedge OCLK, 0:0:0, 0:0:0, notifier);
