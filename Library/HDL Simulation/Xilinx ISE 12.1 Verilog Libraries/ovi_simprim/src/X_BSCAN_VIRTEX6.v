...
//--####################################################################
    initial begin
        ...
        case (DISABLE_JTAG)
            "TRUE", "FALSE" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute DISABLE_JTAG on X_BSCAN_VIRTEX6 instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",  DISABLE_JTAG);
               $finish;
            end
        endcase
    end
