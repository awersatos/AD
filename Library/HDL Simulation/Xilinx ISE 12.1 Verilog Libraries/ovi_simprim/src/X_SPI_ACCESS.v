// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/trilogy/X_SPI_ACCESS.v,v 1.18 2009/08/27 18:58:36 robh Exp $
///////////////////////////////////////////////////////////////////////////////
...
always @(posedge CLK_in or negedge CLK_in)
  begin
    ...
    specify
        ...
        $setuphold (posedge CLK, posedge CSB, 0:0:0, 0:0:0, notifier);
        $setuphold (posedge CLK, negedge CSB, 0:0:0, 0:0:0, notifier);
        $setuphold (negedge CLK, posedge CSB, 0:0:0, 0:0:0, notifier);
        $setuphold (negedge CLK, negedge CSB, 0:0:0, 0:0:0, notifier);

        $setuphold (posedge CLK, posedge MOSI, 0:0:0, 0:0:0, notifier);
        $setuphold (posedge CLK, negedge MOSI, 0:0:0, 0:0:0, notifier);

        $period (posedge CLK, 0:0:0, notifier);

        $width (posedge CSB, 0:0:0, 0, notifier);
