// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/FIFO_SYNC_MACRO.v,v 1.6 2009/08/27 18:32:47 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
   ...
   parameter DEVICE = "VIRTEX5";
    ...
    initial begin
      if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6")
        ...
        begin
          $display("Attribute Syntax Error : The attribute DEVICE on FIFO_SYNC_MACRO instance %m is set to %s.  Legal values of this attribute are VIRTEX5, VIRTEX6", DEVICE);
          $finish;
        end
    end // initial begin
