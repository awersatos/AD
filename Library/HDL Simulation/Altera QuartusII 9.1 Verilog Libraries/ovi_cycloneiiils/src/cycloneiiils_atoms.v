...
//REMSTRATIXIV  //REMHARDCOPYIII parameter  clock_duty_cycle_dependence = "AUTO";
...
`endif
   ram_type = 0;
    ...
    // REMCYCLONEIIILS dataout_a = 'b0;
    // REMCYCLONEIIILS if (mode_is_dp || mode_is_bdp) dataout_b = 'b0;
        dataout_a = 'b0;
