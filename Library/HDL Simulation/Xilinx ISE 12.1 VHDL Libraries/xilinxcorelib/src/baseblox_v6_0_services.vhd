...
package baseblox_v6_0_services is

   -- See below for a description of each of these functions.

   function get_c_mux_bit_v6_0_max_latency(c_has_o, c_has_q, c_inputs : integer) return integer;
   type latency_array_type is array (0 to 2) of integer;
   function get_c_mux_bit_v6_0_latencies(c_has_o, c_has_q, c_inputs  : integer) return latency_array_type;

   function get_c_mux_bus_v6_0_max_latency(c_has_o, c_has_q, c_inputs, mux_type : integer) return integer;
   function get_c_mux_bus_v6_0_latencies(c_has_o, c_has_q, c_inputs, mux_type  : integer) return latency_array_type;

   function get_c_addsub_v6_0_latency (c_out_width : integer; c_has_q_ovfl : boolean) return integer;

end baseblox_v6_0_services;

package body baseblox_v6_0_services is

-- Mux Bit Functions
   
-------------------------------------------------------------------------------
-- Function Name : get_c_mux_bit_v6_0_max_latency
-------------------------------------------------------------------------------   
...
-------------------------------------------------------------------------------   
   ...
   function get_c_mux_bit_v6_0_max_latency(c_has_o, c_has_q, c_inputs : integer) return integer is
   ...
   end get_c_mux_bit_v6_0_max_latency;

-------------------------------------------------------------------------------
-- Function Name : get_c_mux_bit_v6_0_latencies
-------------------------------------------------------------------------------   
...
-------------------------------------------------------------------------------    
   ...
   function get_c_mux_bit_v6_0_latencies(c_has_o, c_has_q, c_inputs : integer) return latency_array_type is
   ...
   end get_c_mux_bit_v6_0_latencies;
...
-------------------------------------------------------------------------------
-- Function Name : get_c_mux_bus_v6_0_max_latency
-------------------------------------------------------------------------------   
...
-------------------------------------------------------------------------------    
   ...
   function get_c_mux_bus_v6_0_max_latency (c_has_o, c_has_q, c_inputs, mux_type : integer) return integer is
   ...
   begin
      ...
      if (mux_type = LOGIC_MUX) then
         ...
         latency := get_c_mux_bit_v6_0_max_latency(c_has_o, c_has_q, c_inputs);
   ...
   end get_c_mux_bus_v6_0_max_latency;

-------------------------------------------------------------------------------
-- Function Name : get_c_mux_bus_v6_0_latencies
-------------------------------------------------------------------------------   
...
-------------------------------------------------------------------------------   
   ...
   function get_c_mux_bus_v6_0_latencies (c_has_o, c_has_q, c_inputs, mux_type : integer) return latency_array_type is   
   ...
   begin
      if (mux_type = LOGIC_MUX) then
         ...
         for i in 0 to 2 loop
            latency_array(i) := get_c_mux_bit_v6_0_latencies(c_has_o, c_has_q, c_inputs)(i);
         end loop;  -- i
      elsif (c_has_q = 1) then
         -- mux is based on Tristate buffers,
         -- and is therefore non pipelined.
   ...
   end get_c_mux_bus_v6_0_latencies;
...
-------------------------------------------------------------------------------
-- Function Name : get_c_addsub_v6_0_latency
-------------------------------------------------------------------------------   
-- Purpose : Returns an integer, which indicates the maximum latency for a
...
-------------------------------------------------------------------------------   
   ...
   function get_c_addsub_v6_0_latency (c_out_width : integer; c_has_q_ovfl : boolean) return integer is
   ...
   end get_c_addsub_v6_0_latency;

   -- end of Addsub functions

-- end of baseblox_v6_0 intelligent functions package.
