...
-- $Id: c_mux_bus_v6_0.vhd,v 1.16 2008/09/08 20:06:06 akennedy Exp $
--
-- Filename - c_mux_bus_v6_0.vhd
-- Author - Xilinx
-- Creation - 4 Feb 1999
--
-- Description - This file contains the behavior for the baseblocks C_MUX_BUS_V6_0 module
...
architecture behavioral of C_MUX_BUS_V6_0 is
...
begin
   ...
   g1 : if (C_HAS_Q = 1) generate       -- Need a register on the output
      ...
      opreg : c_reg_fd_v6_0 generic map(C_WIDTH         => C_WIDTH,
   ...
   g2 : if (C_LATENCY = 2) generate     -- Need a register on the output
       ...
       Pipe1 : c_reg_fd_v6_0 generic map(C_WIDTH          => C_WIDTH,
                                          C_AINIT_VAL     => C_AINIT_VAL,
                                          C_SINIT_VAL     => C_SINIT_VAL,
                                          C_SYNC_PRIORITY => C_SYNC_PRIORITY,
                                          C_SYNC_ENABLE   => C_SYNC_ENABLE,
