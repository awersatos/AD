...
-- $Id: c_mux_bit_v6_0.vhd,v 1.16 2008/09/08 20:06:06 akennedy Exp $
--
-- Filename - c_mux_bit_v6_0.vhd
-- Author - Xilinx
-- Creation - 9 Oct 1998
--
-- Description - This file contains the behavior for the baseblocks C_MUX_BIT_V6_0 module
...
architecture behavioral of C_MUX_BIT_V6_0 is
...
begin
   ...
   g1 : if (C_HAS_Q = 1) generate
      ...
      opreg : c_reg_fd_v6_0 generic map(C_WIDTH         => 1,
   ...
   g2 : if (C_HAS_Q = 1) and (C_LATENCY > 1) generate
      ...
      pipereg1 : c_reg_fd_v6_0 generic map(C_WIDTH         => 1,
                                           C_AINIT_VAL     => C_AINIT_VAL,
                                           C_SINIT_VAL     => C_SINIT_VAL,
                                           C_SYNC_PRIORITY => C_SYNC_PRIORITY,
                                           C_SYNC_ENABLE   => C_SYNC_ENABLE,
...
--   end generate;
   ...
   g3 : if (C_HAS_Q = 1) and (C_LATENCY > 2) generate
      ...
      pipereg2 : c_reg_fd_v6_0 generic map(C_WIDTH         => 1,
                                           C_AINIT_VAL     => C_AINIT_VAL,
                                           C_SINIT_VAL     => C_SINIT_VAL,
                                           C_SYNC_PRIORITY => C_SYNC_PRIORITY,
                                           C_SYNC_ENABLE   => C_SYNC_ENABLE,
