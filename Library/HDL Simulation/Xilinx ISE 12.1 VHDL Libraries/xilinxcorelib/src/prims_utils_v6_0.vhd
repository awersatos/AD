...
-- $Id: prims_utils_v6_0.vhd,v 1.16 2008/09/08 20:06:07 akennedy Exp $
--
-- Filename - prims_utils_v6_0.vhd
-- Author - Xilinx
...
end prims_utils_v6_0;

library IEEE;

package body prims_utils_v6_0 is
            ...
            while ( tok /= '(' ) loop
                       ...
                       while tempi > 0 loop
                          if temp(tempi) = '(' then 
                                             ...
                                             architecture behavioral of PIPELINE_V6_0 is
