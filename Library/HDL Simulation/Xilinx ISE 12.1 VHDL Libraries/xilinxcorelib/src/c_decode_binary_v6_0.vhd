...
-- $Id: c_decode_binary_v6_0.vhd,v 1.16 2008/09/08 20:06:05 akennedy Exp $
--
-- Filename - c_decode_binary_v6_0.vhd
-- Author - Xilinx
-- Creation - 9 Dec 1998
--
...
architecture behavioral of C_DECODE_BINARY_V6_0 is
...
begin
	...
	g1: if C_HAS_Q = 1 generate -- Need a register on the output
		opreg : c_reg_fd_v6_0 generic map(C_WIDTH => C_OUT_WIDTH,
