...
-- $Id: c_shift_fd_v6_0.vhd,v 1.16 2008/09/08 20:06:06 akennedy Exp $
--
-- Filename - c_shift_fd_v6_0.vhd
-- Author - Xilinx
-- Creation - 14 June 1999
--
-- Description - This file contains the behavior for
--				 the C_SHIFT_FD_V6_0 core
...
Use XilinxCoreLib.c_mux_bit_v6_0_comp.all;
...
architecture behavioral of c_shift_fd_v6_0 is
...
begin
	...
	shreg : C_REG_FD_V6_0 generic map(C_WIDTH => C_WIDTH,
	...
	muxwgt1 : if (C_WIDTH>1) generate
		MSBmux : C_MUX_BIT_V6_0 generic map(C_INPUTS => 4,
											C_SEL_WIDTH => 2,
											C_HAS_Q => 0,
											C_HAS_O => 1)
									port map(M => MSBmuxi,
	...
	LSBmux : C_MUX_BIT_V6_0 generic map(C_INPUTS => 4,
										C_SEL_WIDTH => 2,
										C_HAS_Q => 0,
										C_HAS_O => 1)
								port map(M => LSBmuxi,
	...
	muxwgt2 : if (C_WIDTH>2) generate
		muxloop : for i in C_WIDTH-2 downto 1 generate
			shmux : C_MUX_BIT_V6_0 generic map(C_INPUTS => 4,
											C_SEL_WIDTH => 2,
											C_HAS_Q => 0,
											C_HAS_O => 1)
									port map(M => shmuxi(i),
