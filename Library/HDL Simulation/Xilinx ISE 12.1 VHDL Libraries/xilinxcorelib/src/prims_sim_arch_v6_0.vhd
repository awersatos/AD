...
-- $Id: prims_sim_arch_v6_0.vhd,v 1.17 2008/09/08 20:06:06 akennedy Exp $
--
-- Filename - prims_sim_arch_v6_0.vhd
-- Author - Xilinx
...
entity C_BUFT_V6_0 is
   port(I, T : in  std_ulogic;
        O    : out std_ulogic);
end C_BUFT_V6_0;


architecture buft_beh of C_BUFT_V6_0 is
...
configuration cfg_buft_beh of C_BUFT_V6_0 is
   for buft_beh
   end for;
end cfg_buft_beh;
...
-- entity C_PULLUP_V6_0 
-- Source for behavior = Hand crafted 

entity C_PULLUP_V6_0 is
   port(O : out std_ulogic);
end C_PULLUP_V6_0;

architecture pullup_beh of C_PULLUP_V6_0 is
...
configuration cfg_pullup_beh of C_PULLUP_V6_0 is
   for pullup_beh
   end for;
end cfg_pullup_beh;
...
architecture lut_beh of C_LUT_V6_0 is
...
configuration cfg_lut_beh of C_LUT_V6_0 is
   for lut_beh
   end for;
end cfg_lut_beh;
