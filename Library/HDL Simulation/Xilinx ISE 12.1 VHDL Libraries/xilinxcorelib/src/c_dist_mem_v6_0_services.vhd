...
--
-------------------------------------------------------------------------------
-- Distmem v5 Intelligent Functions Package
-------------------------------------------------------------------------------
...
package c_dist_mem_v6_0_services is

   -- See below for a description of each of these functions.

   type latency_array_type is array (natural range <>) of integer;
   function get_c_dist_mem_v6_0_available_latency(c_reg_a_d_inputs, c_has_spo, c_has_qspo : boolean; c_depth : integer; 
   													c_family : string; c_mux_type : integer; c_mem_type : integer) 
   													return latency_array_type;
   function get_c_dist_mem_v6_0_max_latency(c_reg_a_d_inputs, c_has_spo, c_has_qspo : boolean; c_depth : integer; 
   											c_family : string; c_mux_type : integer; c_mem_type : integer) return integer;
   
end c_dist_mem_v6_0_services;

package body c_dist_mem_v6_0_services is

-------------------------------------------------------------------------------
-- Function Name : get_c_dist_mem_v6_0_available_latency
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
	...
	end get_c_dist_mem_v6_0_available_latency;

-------------------------------------------------------------------------------
-- Function Name : get_c_dist_mem_v6_0_max_latency
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
    ...
    end get_c_dist_mem_v6_0_max_latency;

-- end of c_dist_mem_v6_0 intelligent functions package.
