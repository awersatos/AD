...
--
-------------------------------------------------------------------------------
-- sqm_v7_0 Intelligent Functions Package
-------------------------------------------------------------------------------
...
package sqm_v7_0_services is

-------------------------------------------------------------------------------
-- The get_sqm_v7_0_latency is intended for external use.
-- It will report the number of clock cycles required to complete a particular
-- multiplication.
-------------------------------------------------------------------------------

   function get_sqm_v7_0_latency(c_reg_a_b_inputs : integer;
                                 c_sqm_type       : integer;
                                 c_baat           : integer;
                                 c_mult_type      : integer;
                                 c_pipeline       : integer;
...
end sqm_v7_0_services;

package body sqm_v7_0_services is
   ...
   begin
      if (c_mult_type = ccm or c_mult_type = STATIC_RCCM or c_mult_type = DYNAMIC_RCCM) then
         ...
         latency := get_ccm_v7_0_latency(c_a_width, c_has_a_signed, c_a_type, c_reg_a_b_inputs,
