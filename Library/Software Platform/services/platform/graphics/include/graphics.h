...
extern void graphics_set_default_font(graphics_t * restrict graphics, font_t const * default_font);
...
extern int graphics_draw_nstring(canvas_t *canvas, int x, int y, const char *str, const font_t *font, color_t color, fontstyle_t fontstyle, int count);
extern int graphics_get_stringwidth(canvas_t *canvas, const char *str, const font_t *font, fontstyle_t fontstyle);
extern int graphics_get_nstringwidth(canvas_t *canvas, const char *str, const font_t *font, fontstyle_t fontstyle, int count);
...
extern void graphics_draw_bitmap(canvas_t const * restrict canvas, const graphics_bitmap_t *bm, int left, int top, int width, int height, int zoom);
extern void graphics_draw_bitmap_modified(canvas_t const * restrict canvas, const graphics_bitmap_t *bm, int left, int top, int width, int height, int zoom,
                                          bool transparent, color_t transparent_color, bool grayed);
extern void graphics_copy_rect(canvas_t const * restrict canvas, int x, int y, int width, int height, int shift_x, int shift_y);
