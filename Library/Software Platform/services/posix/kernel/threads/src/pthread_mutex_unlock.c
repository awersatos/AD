...
int pthread_mutex_unlock(pthread_mutex_t *mutex)
{
    ...
    {
        /*
         * For mutexes of type PTHREAD_MUTEX_ERRORCHECK and PTHREAD_MUTEX_RECURSIVE
    ...
    if (mutex->type == PTHREAD_MUTEX_RECURSIVE)
    {
        ...
        {
            /* trying to unlock and calling thread is not the owner */
            err = EPERM;
        }
    }

    if (mutex->recursive == 0 && err == 0)
    {
