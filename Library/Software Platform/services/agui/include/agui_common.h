...
typedef struct
{
    ...
    color_t disabled_dark;  /**< dark color of disabled controls */
    color_t disabled_light; /**< light color of disabled controls */
    color_t selected;       /**< color of the selected items in standard dialogs */
    color_t selectedtext;   /**< color of the selected items text in standard dialogs */
