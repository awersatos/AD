...
extern int agui_get_fitting_string_count(agui_t *agui, const string_t *string, int width);
extern int agui_get_breaking_string_count(agui_t *agui, const string_t *string, int width);
//extern const char *agui_cut_string1(agui_t *agui, char *to, const char *from, unsigned int count, const font_t *font, fontstyle_t fontstyle, int width);
...
//extern const char *agui_break_string1(agui_t *agui, char *to, const char *from, unsigned int count, const font_t *font, fontstyle_t fontstyle, int width);
...
extern void agui_draw_body_2d(agui_t *agui, int x, int y, int width, int height, bool top, bool bottom, color_t color, relief_t relief);
