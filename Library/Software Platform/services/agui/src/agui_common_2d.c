...
void agui_draw_body_2d(agui_t *agui, int x, int y, int width, int height, bool top, bool bottom, color_t color, relief_t relief)
{
    ...
    if (top)
    {
        graphics_fill_rect( canvas, x + AGUI_CORNER_RADIUS + 1, y, width - 2 * AGUI_CORNER_RADIUS - 2, AGUI_CORNER_RADIUS + 1, color );     // top-middle
    ...
    if (bottom)
    {
        graphics_fill_rect( canvas, x + AGUI_CORNER_RADIUS + 1, y2 - AGUI_CORNER_RADIUS, width - 2 * AGUI_CORNER_RADIUS - 2, AGUI_CORNER_RADIUS + 1, color );   // bottom-middle
    ...
    graphics_fill_rect( canvas, x, y, width, height, color ); // middle
    if (relief != RELIEF_NONE)
    {
