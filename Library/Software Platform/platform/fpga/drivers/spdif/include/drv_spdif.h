...
extern int spdif_write8( spdif_t * restrict drv, int8_t * buffer, int samples );
extern int spdif_write16( spdif_t * restrict drv, int16_t * buffer, int samples);
extern int spdif_write32( spdif_t * restrict drv, int32_t * buffer, int samples );
extern int spdif_read( spdif_t * restrict drv, int32_t * buffer, int samples );
extern uint32_t spdif_rx_avail(spdif_t * restrict drv);

extern void spdif_tx_start(spdif_t * restrict drv);
extern void spdif_rx_start(spdif_t * restrict drv);
extern void spdif_tx_stop(spdif_t * restrict drv);
extern void spdif_rx_stop(spdif_t * restrict drv);

extern unsigned spdif_set_samplefrequency( spdif_t * restrict drv, unsigned samplerate );

extern void spdif_set_tx_watermark(spdif_t * restrict drv, uint16_t value);
extern void spdif_set_rx_watermark(spdif_t * restrict drv, uint16_t value);
...
extern bool spdif_tx_swbuf_empty( spdif_t * restrict drv );
