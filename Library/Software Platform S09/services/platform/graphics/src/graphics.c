...
graphics_t *graphics_open(unsigned int id)
{
    ...
    graphics_cfg_instance_t * restrict srv_cfg = &graphics_instance_table[id];
    ...
    if (graphics->initialized == false)
    {
        ...
        {
            canvas_initialize(&graphics->canvases[0], (uintptr_t)srv_cfg->canvasbuffer1, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, 0, srv_cfg->default_font);
            canvas_set_rotation(&graphics->canvases[0], srv_cfg->rotation);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[1], (uintptr_t)srv_cfg->canvasbuffer2, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, 0, srv_cfg->default_font);
            canvas_set_rotation(&graphics->canvases[1], srv_cfg->rotation);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[2], (uintptr_t)srv_cfg->canvasbuffer3, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, 0, srv_cfg->default_font);
            canvas_set_rotation(&graphics->canvases[2], srv_cfg->rotation);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[3], (uintptr_t)srv_cfg->canvasbuffer4, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, 0, srv_cfg->default_font);
            canvas_set_rotation(&graphics->canvases[3], srv_cfg->rotation);
        }
#endif
...
int graphics_set_rotation(graphics_t * restrict graphics, int rotation)
{
    ...
    for (int i = 0; i < GRAPHICS_INSTANCE_CANVASCOUNT_MAX; i++)
    {
