...
#define SPDIF_RX_FIFO_FULL              (0x00000001 << 1)           /**< Receiver FIFO full */
#define SPDIF_RX_FIFO_AFULL             (0x00000001 << 0)           /**< Receiver FIFO almost full */
/** @} */
...
#define SPDIF_TX_INT_FIFO_EMPTY         (0x00000001 << 1)           /**< Transmit FIFO empty */
#define SPDIF_TX_INT_FIFO_ALMOST_EMPTY  (0x00000001 << 0)           /**< Transmit FIFO almost empty */
/** @} */
