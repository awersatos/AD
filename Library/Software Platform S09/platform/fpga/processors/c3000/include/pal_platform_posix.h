...
inline void tsk3000_SAVE_REGISTERS_BUT_RA_FP(void)
{
    tsk3000_V0_V1_A0_ER();
...
inline void POSIX_CONTEXT_RESTORE(void)
{
    ...
    //tsk3000_interrupts_disable();
    __asm("mfc0 $v0,$0");
    __asm("addiu    $v1,$zero,-2");
    __asm("and  $v0,$v0,$v1");
    __asm("mtc0 $v0,$0");
...
inline void tsk3000_load_ctx(void *_spptr)
{
    ...
    // * disable interrupts : appl crashes in some tests otherwise : to-test
    __asm("mfc0 $v0,$0");
    __asm("addiu    $v1,$zero,-2");
    __asm("and  $v0,$v0,$v1");
    __asm("mtc0 $v0,$0");

    /* set the IEp bit so interrupts will be enabled after rfe instruction */
    __asm("mfc0 $v0, $Status");
    __asm("or $v0, %0": : "i"(TSK3000_Status_InterruptEnable_Previous));
...
inline void tsk3000_save_ctx(void)
{
    ...
    // enable interrupts : compensate above (*) : to-test
    __asm("mfc0 $v0,$0");
    __asm("ori  $v0,$v0,0x0001");
    __asm("mtc0 $v0,$0");
