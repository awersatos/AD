...
vga_ili9320_t *vga_ili9320_open(unsigned int id)
{
    ...
    drv_vga_ili9320_cfg_instance_t * restrict drv_cfg = &drv_vga_ili9320_instance_table[id];
    // get configuration peripheral below driver (created by plugin system)
    per_vga32_ili9320_cfg_instance_t * restrict per_cfg = &per_vga32_ili9320_instance_table[drv_cfg->per_vga32_ili9320];
